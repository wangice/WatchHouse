...
@MapperScan(basePackages = {"com.ice.brother.house.bos.provider.mapper"}, sqlSessionTemplateRef = "sqlSessionTemplate")
public class MybatisConfig {
  ...
  public SqlSessionFactory sqlSessionFactory(@Qualifier("dataSource") DataSource dataSource)
    ...
    sqlSessionFactoryBean.setTypeAliasesPackage("com.ice.brother.house.bos.provider.entities");
